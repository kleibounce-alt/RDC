 ...
 * GET /order/sales
 */
@WebServlet("/order/sales")
public class OrderSalesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            System.out.println("[OrderSales] 查询销售订单, sellerId=" + sellerId);

            // 调用 Service 查询销售订单
            List<OrderVO> orders = orderService.getMySales(sellerId);

            System.out.println("[OrderSales] 查询结果: " + (orders != null ? orders.size() : 0) + " 条记录");
