...
@WebServlet("/comment/unlike")
public class CommentUnlikeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            boolean success = likeService.unlike(dto);

            if (success) {
                out.print(ResultUtil.success("取消点赞成功", null).toJson());
            } else {
                resp.setStatus(500);
                out.print(ResultUtil.fail(500, "取消点赞失败").toJson());
            }
